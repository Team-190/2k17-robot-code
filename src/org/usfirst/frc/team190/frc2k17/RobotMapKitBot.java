 ...
 * floating around.
 */
public class RobotMapKitBot extends RobotMap{
	
	public RobotMapKitBot() {
		...
		DRIVE_CURVE_TIME_STEP.set(0.02); // seconds
		DRIVE_CURVE_TRACK_WIDTH.set(19.5); // inches
		DRIVE_CURVE_WHEEL_DIAMETER.set(4.0); // inches
		DRIVE_CURVE_WHEEL_CIRCUMFERENCE.set(Math.PI * DRIVE_CURVE_WHEEL_DIAMETER.get());
		DRIVE_LEFT_MOTOR_INVERTED.set(false);
		DRIVE_RIGHT_MOTOR_INVERTED.set(true);
		DRIVE_LEFT_ENC_INVERTED.set(false);
		DRIVE_RIGHT_ENC_INVERTED.set(true);
