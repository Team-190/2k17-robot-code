...
public class PIDController implements PIDInterface, LiveWindowSendable, Controller {
  ...
  public PIDController(double Kp, double Ki, double Kd, double Kf, PIDSource source,
    ...
    m_maxErrorToIntegrate = Double.MAX_VALUE;
  ...
  protected double calculateFeedForward() {
    ...
    /**
     * Set the minimum error value that will cause the accumulated integral to be set to zero
     * If the error term is large, it can potentially accumulate to have a huge effect on the output
     ...
     */
    public void setMaxErrorToIntegrate(double m) {
        m_maxErrorToIntegrate = m;
    }
