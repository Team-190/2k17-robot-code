...
public final class RobotMap {
	...
	public static final class Constants {
		public static final class DriveTrain {
			...
			DRIVE_PID_TURN_KP = 0.00525, // max speed at 180 deg of error
			DRIVE_PID_TURN_KI = 0.00000,
			DRIVE_PID_TURN_KD = 0.00000,
			
			DRIVE_PID_HEADING_CORRECTION_KP = 0.0,
			DRIVE_PID_HEADING_CORRECTION_KI = 0.0,
			DRIVE_PID_HEADING_CORRECTION_KD = 0.0,
			
			DRIVE_PID_DISTANCE_KP = 4.68430, //8, //10, //12,
			...
			DRIVE_PID_TURN_TOLERANCE = 3.0, // Degrees
