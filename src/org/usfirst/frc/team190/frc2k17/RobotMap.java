...
public class RobotMap {
	public final Key<Integer>
		...
		CAN_DRIVE_MOTOR_LEFT_FRONT = new Key<Integer>(3),
		CAN_DRIVE_MOTOR_LEFT_REAR = new Key<Integer>(6),
		CAN_DRIVE_MOTOR_RIGHT_FRONT = new Key<Integer>(2),
		CAN_DRIVE_MOTOR_RIGHT_REAR = new Key<Integer>(5),
		CAN_DRIVE_MOTOR_LEFT_MASTER = new Key<Integer>(CAN_DRIVE_MOTOR_LEFT_FRONT.get(), CAN_DRIVE_MOTOR_LEFT_REAR.get()),
		CAN_DRIVE_MOTOR_LEFT_SLAVE = new Key<Integer>(CAN_DRIVE_MOTOR_LEFT_REAR.get(), CAN_DRIVE_MOTOR_LEFT_FRONT.get()),
		CAN_DRIVE_MOTOR_RIGHT_MASTER = new Key<Integer>(CAN_DRIVE_MOTOR_RIGHT_FRONT.get()),
		CAN_DRIVE_MOTOR_RIGHT_SLAVE = new Key<Integer>(CAN_DRIVE_MOTOR_RIGHT_REAR.get()),
